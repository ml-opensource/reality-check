...
import RealityKit
  ...
  private func syncComponentToStrings(
    _ component: SynchronizationComponent,
    detail: Int
  )
    -> [String]
  {
  ...
  private func anchoringComponentToStrings(
    _ component: AnchoringComponent,
    detail: Int
  )
    -> [String]
  {
  ...
  private func collisionComponentToStrings(
    _ component: CollisionComponent,
    detail: Int
  )
    -> [String]
  {
  ...
  private func physicsBodyComponentToStrings(
    _ component: PhysicsBodyComponent,
    detail: Int
  )
    -> [String]
  {
  ...
  private func physicsMotionComponentToStrings(
    _ component: PhysicsMotionComponent,
    detail: Int
  )
    -> [String]
  {
  ...
  private func characterControllerComponentToStrings(
    _ component: CharacterControllerComponent,
    detail: Int
  ) -> [String] {
    var strings = [String]()
  ...
  private func characterControllerStateComponentToStrings(
    _ component: CharacterControllerStateComponent,
    detail: Int
  ) -> [String] {
    var strings = [String]()
